...
foreach ($list as $i => &$item) :
	...
	if ($item->deeper)
	{
		echo '<ul class="nav-child unstyled small" style="padding-left: unset;">';
	}
...
endforeach;
?></ul></div>
<div style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:10px; text-align:right; display:block; padding-right:10px;">
</div>
